...
const CardContactInfor = ({
  ...
  return (
    <div className="flex flex-col gap-4 bg-background hover:bg-primary/5 hover:border border-b-primary p-4 w-full text-gray-400 shadow-sm rounded-md transition-colors duration-300">
